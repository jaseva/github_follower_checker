...
# Usage
To use the Github follower checker, clone this repository to your local machine and run the github_follower_checker_pagination.py script in the terminal. The script takes the following arguments:
...
`python github_follower_checker_pagination.py --username USERNAME --token YOUR_TOKEN --output FILENAME`
